...
const StatementSorting = (props) => {
  ...
  const [allStatements, setAllStatements] = useState([
    { id: 'statement1', content: 'Scammers always use the same tactics.', isTrue: false },
    { id: 'statement2', content: 'Scams can only occur through the internet. ', isTrue: false },
    { id: 'statement3', content: 'Scams always involve a direct request for payment.', isTrue: false },
    { id: 'statement4', content: 'Scammers always use fear/urgency to manipulate victims.', isTrue: true },
    { id: 'statement5', content: 'Scammers always use high-pressure tactics to obtain payment.', isTrue: true },
  ]);
  ...
  <View style={styles.buttonContainer}>
    ...
    <View style={styles.nextButtonContainer}>
      <Button title="Next" onPress={() => props.navigation.navigate("DragDrop2")} />
    </View>
  </View>
)}
    </View>
...
export default StatementSorting;
