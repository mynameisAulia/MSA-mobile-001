...
function TopicCard() {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('VideoList1')} style={styles.button}>
          <Image source={ScamImage1} style={styles.buttonImage} />
          <Text style={styles.buttonText}>SCAM</Text>
        </TouchableOpacity>
      
      <TouchableOpacity onPress={() => navigation.navigate('VideoList2')} style={styles.button}>
