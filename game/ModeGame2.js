...
function ModeGame2() {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('GameSEH')} style={styles.button}>
          <Image source={hackerImage} style={styles.buttonImage} />
          <Text style={styles.buttonText}>HACKER</Text>
        </TouchableOpacity>
      
      <TouchableOpacity onPress={() => navigation.navigate('GameSEV')} style={styles.button}>
